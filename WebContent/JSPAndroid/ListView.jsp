...
try
{
	...
	String sql="SELECT course.Course_Name,Takes.present,Takes.gyulsuk,Takes.jigak,Takes.jotae FROM Takes,Student,course where Student.ID=Takes.s_ID and Student.Name=? and course.ID=Takes.course_ID"; 
